...
def chat_web_chat_home():
    ...
    return render_template('chat web/chat_home.html', chats=chats, title=' Chat Home', legend='Home Chat',func=read_image)
...
def chat_web_chat_app_g1():
    ...
    return render_template('chat web/chat_app_g1.html', chats=chats, title=' Chat App G1', 
                           legend='App Module Chat, Group 1',func=read_image)
...
def chat_web_chat_app_g2():
    ...
    return render_template('chat web/chat_app_g2.html', chats=chats, title=' Chat App G2', 
                           legend='App Module Chat, Group 2',func=read_image)
...
def chat_web_chat_app_g3():
    ...
    return render_template('chat web/chat_app_g3.html', chats=chats, title=' Chat App G3', 
                           legend='App Module Chat, Group 3',func=read_image)
...
def chat_web_chat_app_g4():
    ...
    return render_template('chat web/chat_app_g4.html', chats=chats, 
                           title=' Chat App G4', legend='App Module Chat, Group 4',func=read_image)
...
def chat_web_chat_se_g1():
    ...
    chats = Chat.query.filter(Chat.chat_module.is_('Sustainable Energy Module Chat')).\
        filter(Chat.chat_group.is_('Group 1')).order_by(Chat.date_posted.desc()).paginate(page=page, per_page=2)
    return render_template('chat web/chat_se_g1.html', chats=chats, title=' Chat SE G1', 
                           legend='Sustainable Energy Module Chat, Group 1',func=read_image)
...
def chat_web_chat_se_g2():
    ...
    chats = Chat.query.filter(Chat.chat_module.is_('Sustainable Energy Module Chat')).\
        filter(Chat.chat_group.is_('Group 2')).order_by(Chat.date_posted.desc()).paginate(page=page, per_page=2)
    return render_template('chat web/chat_se_g2.html', chats=chats, title=' Chat SE G2', 
                           legend='Sustainable Energy Module Chat, Group 2',func=read_image)
...
def se_web_ch1_ex1_questionnaire():
    ...
    return render_template('se web/se_web_ch1_ex1_questionnaire.html', title='SE Web - Ch1 - Ex1',
...
def se_web_ch1_ex1_chat():
    ...
    return render_template('se web/chat/ch1_ex1_create.html', title='SE Web - Ch1 - Ex1',
...
def se_web_ch1_ex1_chat_query():
    ...
    chats = Chat.query.filter(Chat.chat_module.is_('SE_ch1_ex1')).order_by(Chat.date_posted.desc()).paginate(page=page,
                                                                                                            per_page=4)
    return render_template('se web/chat/ch1_ex1_query.html', title='SE Web - Ch1 - Ex1',
...
def se_web_ch1_ex2_questionnaire():
    ...
    return render_template('se web/se_web_ch1_ex2_questionnaire.html', title='SE Web - Ch1 - ex2',
...
def se_web_ch1_ex2_chat():
    ...
    return render_template('se web/chat/ch1_ex2_create.html', title='SE Web - Ch1 - Ex2',
...
def se_web_ch1_ex2_chat_query():
    ...
    chats = Chat.query.filter(Chat.chat_module.is_('SE_ch1_ex2')).order_by(Chat.date_posted.desc()).paginate(page=page,
                                                                                                            per_page=4)
    return render_template('se web/chat/ch1_ex2_query.html', title='SE Web - Ch1 - ex2',
