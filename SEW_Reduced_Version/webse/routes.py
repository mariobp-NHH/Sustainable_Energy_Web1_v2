...
def chat_web_chat_home():
    ...
    return render_template('chat web/chat_home.html', chats=chats, title=' Chat Home')
...
def chat_web_chat_app_g4():
    ...
    return render_template('chat web/chat_app_g4.html', chats=chats, title=' Chat App G4')
